...
(function () {
    ...
    const hasProto = (v, constructor, predicate) => {
        ...
        if (predicate(v, constructor.prototype)) {
            ...
            return (
                ((_a = v.constructor) === null || _a === void 0
                    ? void 0
                    : _a.name) === constructor.name
            );
        }
    };
    const typeOf = (x) => {
    ...
    const register$2 = (editor) => {
        ...
        const charMapProcessor = (value) =>
            isFunction(value) || isArray$1(value);
    ...
    const open = (editor, charMap) => {
        ...
        const currentTab =
            charMap.length === 1 ? Cell(UserDefined) : Cell("All");
