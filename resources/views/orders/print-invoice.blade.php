                                ...
                                <table class="default-table invoice-table">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($order->details as $item)
                                            <tr>
                                                ...
                                                <td class="align-middle text-center">
                                                    {{ Number::currency($item->unitcost, 'NGN') }}
                                                </td>
                                                <td class="align-middle text-center">
                                                    {{ $item->quantity }}
                                                </td>
                                                <td class="align-middle text-center">
                                                    {{ Number::currency($item->total, 'NGN') }}
                                                </td>
                                            </tr>
                                        @endforeach
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle text-center">
                                                <strong>
                                                    {{ Number::currency($order->sub_total, 'NGN') }}
                                                </strong>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle text-center">
                                                <strong>
                                                    {{ Number::currency($order->total, 'NGN') }}
                                                </strong>
                                            </td>
                                        </tr>
                                    </tbody>
